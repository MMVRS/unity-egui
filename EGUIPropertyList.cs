...
namespace Build1.UnityEGUI
{
	public static partial class EGUI
	{
		...
		public static PropertyListWithSource<I, T> PropertyListWithSource<I, T>(object instance, T source, IList<I> items, string propertyName)
		{
			var type = instance.GetType();
			var property = type.GetProperty(propertyName);
			...
			var list = new PropertyListWithSource<I, T>(FormatCameCase(propertyName), itemsGot, source);
			list.OnCreate(i => { property.SetValue(instance, i); });
