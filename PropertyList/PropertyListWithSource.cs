...
namespace Build1.UnityEGUI.PropertyList
{
	public class PropertyListWithSource<I, T>
	{
		...
		internal PropertyListWithSource(string label, List<I> items, T itemsSource)
		{
			Label = label;
			Items = items;
		...
		internal PropertyListWithSource<I, T> OnCreate(Action<List<I>> handler)
		{
			_onCreate = handler;
			return this;
		}
		...
		public PropertyListWithSource<I, T> NoTitle()
		{
			_titleShow = false;
			return this;
		}

		public PropertyListWithSource<I, T> Title(string title, params Property[] properties)
		{
			_title = title;
		...
		public PropertyListWithSource<I, T> NoCount()
		{
			_countShow = false;
			return this;
		}

		public PropertyListWithSource<I, T> NoPanel()
		{
			_panelShow = false;
			return this;
		}

		public PropertyListWithSource<I, T> OnFilters(Action handler)
		{
			_onFilters = handler;
			return this;
		}

		public PropertyListWithSource<I, T> ItemRenderer<R>() where R : PropertyListItemRenderer<I>
		{
			_itemRendererType = typeof(R);
			return this;
		}

		public PropertyListWithSource<I, T> ItemRenderer<R>(params ButtonType[] buttons) where R : PropertyListItemRenderer<I>
		{
			_itemRendererType = typeof(R);
		...
		public PropertyListWithSource<I, T> ItemButtons(params ButtonType[] buttons)
		{
			_itemRendererButtons = buttons;
			return this;
		}

		public PropertyListWithSource<I, T> OnItemRender(Action<PropertyListItemRenderer<I>> handler)
		{
			_onItemRender = handler;
			return this;
		}

		public PropertyListWithSource<I, T> OnItemTitle(Func<I, string> handler)
		{
			_onItemTitle = handler;
			return this;
		}

		public PropertyListWithSource<I, T> OnItemFilter(Func<I, bool> handler)
		{
			_onItemFilter = handler;
			return this;
		}

		public PropertyListWithSource<I, T> WindowRenderer<W>() where W : PropertyWindow<I, T>
		{
			_windowRendererType = typeof(W);
			return this;
		}
		
		public PropertyListWithSource<I, T> OnItemAdd(Func<I> handler)
		{
			_onItemAdd = handler;
			return this;
		}

		public PropertyListWithSource<I, T> OnItemCopy(Func<I, I> handler)
		{
			_onItemCopy = handler;
			return this;
		}

		public PropertyListWithSource<I, T> OnItemAddAvailable(Func<bool> handler)
		{
			_onItemAddAvailable = handler;
			return this;
		}

		public PropertyListWithSource<I, T> OnItemAddValidation(Func<bool> handler)
		{
			_onItemAddValidation = handler;
			return this;
		}

		public PropertyListWithSource<I, T> OnItemIndexChanged(Action<I, int> handler)
		{
			_onItemIndexChanged = handler;
			return this;
		}

		public PropertyListWithSource<I, T> OnItemDelete(Func<I, bool> handler)
		{
			_onItemDelete = handler;
			return this;
		}

		public PropertyListWithSource<I, T> OnItemDetails(Action<I> handler)
		{
			_onItemDetails = handler;
			return this;
		}

		public PropertyListWithSource<I, T> ReadOnly()
		{
			_isReadOnly = true;
			return this;
		}

		public PropertyListWithSource<I, T> Pager(int pageSize, object pageStorageKey)
		{
			_pageSize = pageSize;
			...
			switch (action)
			{
				...
				case PropertyListItemAction.Details:
					...
					if (_windowRendererType != null)
					{
						...
						EGUI.PropertyWindow(_windowRendererType, item, index, Items, ItemsSource);
					}
					else
					{
						if (_onItemDetails == null)
							EGUI.LogError("EGUI: PropertyListWithSource details handler not specified");
						else
